        ...
        <div class="container py-3">
            ...
            <div class="dropdown" v-if="logado">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" @click.prevent="">Imóveis</a></li>
                    <li><a class="dropdown-item" @click.prevent="">Transações</a></li>
                    <li><a class="dropdown-item" @click.prevent="">Perfil</a></li>
...
export default{
    ...
    methods: {
        async verificarLogin() {
            let logado = await localStorage.getItem('token') === '123456789' ? true : false;
            this.logado = logado;
